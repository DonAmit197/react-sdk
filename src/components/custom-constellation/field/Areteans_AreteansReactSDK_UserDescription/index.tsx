...
function AreteansAreteansReactSdkUserDescription(props: AreteansAreteansReactSdkUserDescriptionProps) {
  const {
    getPConnect,
    value,
    hideLabel = false,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledAreteansAreteansReactSdkUserDescriptionWrapper>{displayComp}</StyledAreteansAreteansReactSdkUserDescriptionWrapper>
    ) : (
...
export default withConfiguration(AreteansAreteansReactSdkUserDescription);
